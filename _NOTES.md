...
Findings from modernizing this bundle's test suites (the working pattern is described in `taskmate.tmbundle/_NOTES.md`). This was a genuine port, not a cleanup: the suites were written for RSpec 1 with hpricot for HTML assertions.
